...
{
    class SphQuadTriangle : QuadCurvedTriangle
    {
        public SphQuadTriangle(Vertex[] vertexs, Side[] sides, int facetID, int faceID,
        ...
        protected override void QuadraticFromPtsNormals(Position p1, Position p2, Vector n1, Vector n2, out Position p12, out double weight)
        {
            ...
            {
                Compute.DistanceResult result = Snap.Compute.ClosestPoints(new Snap.Geom.Curve.Ray(p1, h), new Snap.Geom.Curve.Ray(p2, k));
